...
def LoadHippocampusData(root_dir, y_shape, z_shape):
    ...
    for f in images:
        ...
        # <YOUR CODE GOES HERE>
        # added normalization of all images 
        normlized_image = np.asarray(image).astype('float32') / 255.0
        ...
        # ANSWER: It will be much faster and memory efficient after casting labels to int
